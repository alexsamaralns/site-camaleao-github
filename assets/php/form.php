...
if(isset($_POST['subject']) && isset($_POST['name']) &&  isset($_POST['email']) && isset($_POST['tel'])
  ...
  //Check if person already exist by e-mail
  $curl = curl_init();

  curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://api.movidesk.com/public/v1/persons?token=f0ae371e-5848-45eb-a109-b3d66a105d98&$filter=emails%20/any(c:c/%20email%20eq%20\''.$email.'\'%20)',
